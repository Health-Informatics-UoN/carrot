...
export default function Hero() {
  return (
    <>
      <div className="flex-col overflow-hidden lg:flex lg:flex-row lg:justify-between items-start min-h-[60vh] lg:pt-24 pt-12">
        <div className="flex flex-col lg:space-y-5 space-y-3 lg:w-3/5">
          <div className="lg:text-5xl text-2xl gap-5 text-center lg:text-left">
            <h1 className="text-carrot">Streamlined Data Mapping</h1>
            <h1>to OMOP</h1>
          </div>
