...
If you are working with the source code, reffer to the [Development Notes](https://github.com/Health-Informatics-UoN/carrot-transform/development.md#running-from-source)
