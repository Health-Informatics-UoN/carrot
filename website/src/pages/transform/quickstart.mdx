...
| **Specify Version** | `--omop-version` (e.g., `5.3`, which will automatically find `carrottransform/config/config.json` and `carrottransform/config/OMOPCDM_postgresql_XX_ddl.sql`) |
