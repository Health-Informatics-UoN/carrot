...
|---------------------|----------------------|----------------------|-------------|
| **Specify Files**   | `--omop-ddl-file`    | `OMOP_DDL_FILE`      | `--omop-ddl-file` (DDL statements for OMOP tables. The version 5.4 of OMOP CDM can be downloaded from [here](https://github.com/Health-Informatics-UoN/carrot-transform/blob/main/carrottransform/config/OMOPCDM_postgresql_5.4_ddl.sql)) |
| **Specify Version** | `--omop-version`     |                      | `--omop-version` (e.g., `5.4`, which will automatically find `carrottransform/config/config.json` and `carrottransform/config/OMOPCDM_postgresql_XX_ddl.sql`) |
