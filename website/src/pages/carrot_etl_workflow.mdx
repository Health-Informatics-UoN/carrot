...
- **CarrotTransform_output_sample/** - Folder containing example Transform output (for reference)
  - **PERSON.tsv** - Example transformed person/demographic data
  - **CONDITION_OCCURRENCE.tsv** - Example transformed condition data
  - Other OMOP CDM table files showing the expected output format
