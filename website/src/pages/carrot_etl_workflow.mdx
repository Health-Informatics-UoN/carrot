...
**WhiteRabbit Input Files:**
- **patients.csv** - Patient demographics and contact information
- **test_with_dates.csv** - Sample data with various date formats
- **test_data.csv** - Additional test data for profiling
- **CONCEPT.csv** and **CONCEPT_SYNONYM.csv** - Medical concept reference data

**WhiteRabbit Output Examples:**
- **ScanReport_csv.xlsx** - Example scan report for CSV data
- **ScanReport_sas.xlsx** - Example scan report for SAS data
- **fake_data_csv/** - Generated fake data samples

**Test Scan Reports:**
- **ScanReport_minimal.xlsx** - Minimal scan report example
- **ScanReport_with_empty.xlsx** - Scan report with empty values
