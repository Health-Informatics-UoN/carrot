...
<div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "10px" }}>
  ...
  The anonymization of data is paramount, it is critical that the following steps are carefully followed.
  ...
  **Anonymise dataset**
  ...
  <figure style={{ display: "inline-block", textAlign: "center", margin: "0 auto" }}>
    <img 
      ...
      alt="Data Anonymization during data pre-processing" 
      width="200"
      height="250"
      style={{ 
        maxWidth: "100%", 
