...
## Execute Data Transformation with Sample Data
...
uv run -m carrottransform.cli.subcommands.run mapstream \
    ...
    --rules-file carrottransform/examples/test/rules/rules_2Dec2025_V1.json \
    --output-dir build \
...
```bash
uv run -m carrottransform.cli.subcommands.run_v2 folder \
   --input-dir carrottransform/examples/test/inputs \
   --person-file carrottransform/examples/test/inputs/patients.csv \
   --rules-file carrottransform/examples/test/rules/rules_2Dec2025.json \
   --output-dir build \
...
> uv run -m carrottransform.cli.subcommands.run_v2 folder \
   --input-dir carrottransform/examples/test/inputs \
   --person-file carrottransform/examples/test/inputs/patients.csv \
   --rules-file carrottransform/examples/test/rules/rules_2Dec2025_V2.json \
   --output-dir build \
   --omop-ddl-file carrottransform/config/OMOPCDM_postgresql_5.4_ddl.sql
