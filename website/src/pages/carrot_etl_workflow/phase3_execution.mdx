...
**Carrot Transform** is like the **worker** that actually does the heavy lifting.

Think of it this way:
- **WhiteRabbit** (Phase 1) = Inspector who examines your data
- **Carrot Mapper** (Phase 2) = Architect who creates the blueprint
- **Carrot Transform** (Phase 3) = Construction crew that builds according to the blueprint

**What Carrot Transform does:**
- Takes your mapping rules from Carrot Mapper
- Reads your original data files
- Applies all the transformations you specified
- Creates new files in the standard OMOP CDM format
- Checks that everything was done correctly

**Why this step is important:**
- This is where your data actually gets converted from its current format to the standard format
- It's like having a translator who speaks both languages fluently
- It ensures your data follows all the OMOP CDM rules and standards
- It creates the final output that researchers can actually use
...
<Callout type="info">
  **System Requirements:** Carrot Transform requires Python 3.10 or higher. For database operations, you may need additional system libraries (e.g., PostgreSQL development headers).
</Callout>
...
*This completes the Carrot ETL End-to-End Workflow Documentation. Remember that ETL development is iterative - continue to monitor, optimize, and improve your processes based on real-world usage and feedback.*
