...
Let's note that since we have V1 and V2 rules, they are transformed differently. For us to transform V1 rules, we use the command below:
...
### Version 2 Process
For this example, we shall make use of the JSON V2 file we downloaded from carrot mapper. You can also find it [here →](/sample-data/sample-data.zip)
