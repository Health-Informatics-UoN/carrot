...
The final phase of the Carrot ETL workflow focuses on executing the data transformation process and validating the results. This phase brings together all the work from the previous phases to actually transform your source data into OMOP CDM format and ensure data quality and compliance.
