...
<Callout type="info">
  **Sample Files:** You can find example scan reports and sample data dictionaries in the [Carrot GitHub repository example files](https://github.com/Health-Informatics-UoN/carrot/tree/main/example%20files).
</Callout>
