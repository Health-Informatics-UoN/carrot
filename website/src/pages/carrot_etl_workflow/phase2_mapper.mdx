...
We then click add and mapper will apply the OMOP concept we selected. After selecting, we shall see a green toast message confirming the successful addition `OMOP Concept successfully added.`
