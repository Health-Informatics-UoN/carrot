...
The second phase of the Carrot ETL workflow focuses on using Carrot Mapper to create data mappings and transformation rules. This phase transforms the insights gained from WhiteRabbit profiling into actionable ETL configurations that can convert your source data into OMOP CDM format.
...
<Callout type="info">
  **Note:** Carrot Mapper is typically accessed through a web interface. Ensure you have the correct URL and access credentials before beginning this phase.
</Callout>
...
```yaml
project_settings:
  name: "Hospital Data ETL Project"
  description: "Transform hospital EHR data to OMOP CDM v5.4"
  version: "1.0.0"
...
After completing the data mapping configuration in Carrot Mapper, you'll have a comprehensive ETL configuration ready for execution. The next phase focuses on [Data Execution and Validation](./phase3_execution).
