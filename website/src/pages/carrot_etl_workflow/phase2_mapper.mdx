...
#### Access Your Uploaded Scan Report
...
<div style={{ textAlign: "center", marginTop: "24px", marginBottom: "32px" }}>
  <figure style={{ margin: "0" }}>
    <img 
      ...
      alt="Getting ready to begin manual mapping" 
      width="100%"
      height="auto"
      style={{ 
        maxWidth: "800px", 
...
## Manually Mapping Data Values (Alternative Method)
