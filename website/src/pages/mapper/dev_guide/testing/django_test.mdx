...
3. _(Optional)_ If you have data that can be reused in multiple tests, you can write a `setUp` method that will be ran before each test in the `class`. Make sure to prepend `self.` to your variable.
