...
**There are two options for storage services: `azure` or `minio` .**

<div>
  <Tabs items={['Azure Blob','MinIO', ]}>
    <Tabs.Tab label="Azure Blob">
      <div>
        ...
        Since, we decided to use **Azure as a Storage**, Carrot will automatically create the necessary resources which are mentioned below:
      ...
      **[Optional]** - You can **check the created Azure resources** by following the steps below:  
