...
Navigate to `Environment variables` section under `Settings` of your Airflow Scheduler app, then add the variables as outlined in the [configuration](/mapper/deployment/configuration#airflow-webserver-and-scheduler).


### Airflow Webserver app

Navigate to `Environment variables` section under `Settings` of your Airflow Webserver app, then add the variables as outlined in the [configuration](/mapper/deployment/configuration#airflow-webserver-and-scheduler).
